...
conn:on("connection", function(conn, payload) 
                       conn:send("GET /d/quotes.csv?s="..parm[1].."&f=nsl1d1t1&e=.csv"
                        .."T="..(tmr.now()-Tstart)
                        .."&heap="..node.heap()
                        .." HTTP/1.1\r\n" 
...
-- FOREX http://download.finance.yahoo.com/d/quotes.csv?s=AUDHKD=X&f=nsl1d1t1&e=.csv
-- to call: loadfile("yahooForexQuoteRetrieval.lua") ( "AUDHKD=X" )